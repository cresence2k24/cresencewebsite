      ...
      <div className='container mx-auto'>
        <div className='flex flex-col lg:flex-col lg:items-center lg:gap-x-12'>
          ...
          <div className='flex flex-col justify-center items-center text-center font-secondary'>
            <RevealRight>
            <h1 id='title1' className='text-gradient animate-gradient text-[46px] font-bold leading-[0.8] lg:text-[80px] my-16 lg:my-5 drop-shadow-3xl'>
              CreSencE
            </h1>
            </RevealRight>
            <RevealLeft>
            <div id='title2' className='text-[42px] lg:text-[40px] font-secondary font-semibold uppercase leading-[1]'>
            ...
            <div id='title4' className='flex max-w-max gap-x-6 items-center mb-12 mx-auto lg:mx-0'>
