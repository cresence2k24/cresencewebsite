...
const Banner = () => {
  return (
    <section className='min-h-[70vh] lg:min-h-[0vh] flex items-center' id="home">
      <div className='container mx-auto'>
        <div className='flex flex-col gap-y-8 lg:flex-row lg:items-center lg:gap-x-12'>
          ...
          <div className='flex-1 text-center font-secondary lg:text-left'>
            <motion.h1 variants={fadeIn('right', 0.1)} initial="hidden" whileInView={'show'} viewport={{ once: false, amount: 0.01 }} className='text-gradient text-[42px] font-bold leading-[0.8] lg:text-[80px] my-16 lg:my-5 drop-shadow-3xl'>
              CreSencE
            </motion.h1>
            ...
            <motion.p variants={fadeIn('up',0.03)} initial="hidden" whileInView={'show'} viewport={{ once: false, amount: 0.01 }} className='mb-8 max-w-lg mx-auto lg:mx-0'>
