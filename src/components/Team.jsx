          ...
          <div className="flex flex-col justify-center items-center mx-10 mb-8">
            ...
            <Reveal>
              <p className="max-w-[455px]">
                The team of "Cresence" is a dynamic group of young individuals
                who are eager to make a difference in the tech industry. Their
                hard work, dedication, and passion for technology are reflected
                in the success of the festival, making it an exciting and
                              ...
                              {member.twitter && (
                                ...
                                >
                                  ...
                                  <svg
                                    ...
                                    stroke-width="0"
                                    viewBox="0 0 512 512"
                                    class="w-6 h-6 text-gray-400 hover:text-gray-100"
                                    height="1em"
                                    width="1em"
