...
function Contact() {
  ...
  const validate = () => {
    if (inputValues.Name === "") {
      ...
      return false;
    } else if (inputValues.Phone === "" || inputValues.Phone.length !== 10) {
        ...
        >
          ...
          <div className="mb-6">
            ...
            <input
              ...
              onChange={handleOnChange}
              className=" autofill:bg-yellow-200 shadow appearance-none rounded-lg w-full py-2 px-3 bg-transparent border-[2px] border-purple-800 autofill:bg-transparent text-white leading-tight focus:outline-none focus:shadow-outline"
